from src.processing import get_list_with_state, sort_list_by_date, sort_list_by_price, avg_cost_and_quantity
import pytest
...
def info_about_products():
    return [{'name': 'apple', 'price': 40, 'category': 'fruits', 'quantity': 14},
...
@pytest.fixture
def info_about_internet_orders():
    return [
        {
            'id': 1,
            'date': '2023-09-15',
            'items': [{'name': 'Table', 'price': 8000, 'quantity': 1}]
        },
        {
            'id': 2,
            'date': '2023-09-26',
            'items': [{'name': 'Notebooks', 'price': 300, 'quantity': 12}]
        },
        {
            'id': 3,
            'date': '2023-10-04',
            'items': [{'name': 'TV', 'price': 20000, 'quantity': 1}]
        },
        {
            'id': 4,
            'date': '2023-10-19',
            'items': [{'name': 'Milk', 'price': 600, 'quantity': 10}]
        },
        {
            'id': 5,
            'date': '2023-11-01',
            'items': [{'name': 'T-shirts', 'price': 2000, 'quantity': 5}]
        },
        {
            'id': 6,
            'date': '2023-11-05',
            'items': [{'name': 'Sneakers', 'price': 6000, 'quantity': 1}]
        }
    ]


def test_get_list_with_state(coll):
    assert get_list_with_state(coll) == [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                                         {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}]
...
def test_sort_list_by_date(list_of_date):
...
def test_sort_list_by_price(info_about_products):
...
def test_avg_cost_and_quantity(info_about_internet_orders):
